...
<modules>
	<module version="0.1">de.marcelpociot.splashscreen</module>
</modules>
...
For example,
	...
	var my_module = require('de.marcelpociot.splashscreen');
	my_module.foo();
...
To create a module, create a file named de.marcelpociot.splashscreen.js under the assets folder.
